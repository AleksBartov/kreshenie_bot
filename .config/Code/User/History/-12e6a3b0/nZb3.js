...
// Ваши авторизационные данные из скриншота
...
const api = axios.create({
  ...
  headers: {
    ...
    'Cookie': _ga=GA1.2.899629649.1760383314; _gid=GA1.2.1649209595.1760383314; _ym_uid=1760383318884942455; _ym_d=1760383318; _ym_isad=1; sso-key=${ssoKey}; X-JWT-Token=${token}
  }
});
...
async function testAuth() {
  try {
    ...
    // Проверяем, что получили HTML страницу (а не страницу логина)
    ...
    if (error.response) {
      ...
      console.log('Текст ошибки:', error.response.statusText);
